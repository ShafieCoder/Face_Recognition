...
#Younes is trying to enter the office and the camera takes a picture of him
#("images/camera_0.jpg"). Let's run your verification algorithm on this picture:
# BEGIN UNIT TEST
...
def who_is_it(image_path, database, model):
    ...
    for (name, db_enc) in database.items():
        ...
        dist = np.linalg.norm(tf.subtract(encoding,db_enc),ord = 2)
